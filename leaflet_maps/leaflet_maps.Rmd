...
This is from the [fifth chapter](https://learn.r-journalism.com/en/mapping/leaflet_maps/leaflet/) of [learn.r-journalism.com](https://learn.r-journalism.com/).
...
library(knitr)
include_graphics("images/right_map.png")
```
...
include_graphics("images/lat_lon.png")
```
...
include_graphics("images/filename.png")
```
...
include_graphics("images/file.png")
```
