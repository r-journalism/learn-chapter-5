...
* Geolocating data
  * Getting latitude and longitude from addresses
* Traffic stops case study
  * Looking for racial profiling in traffic stops
* Interactive maps with Leaflet
  * Locator maps and geolocating addresses
* Interactive choropleth maps
  * With Starbucks and Census data
